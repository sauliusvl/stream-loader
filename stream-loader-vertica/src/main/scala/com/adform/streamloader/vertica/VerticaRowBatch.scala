...
import com.adform.streamloader.sink.batch.stream.{BaseStreamBatchBuilder, CsvFormat, CsvStreamBatchBuilder, StreamBatch}
import com.adform.streamloader.sink.encoding.csv.CsvRecordEncoder
import Compression.NONE
import com.adform.streamloader.vertica.native.{NativeVerticaRecordEncoder, NativeVerticaRecordStreamWriter}
